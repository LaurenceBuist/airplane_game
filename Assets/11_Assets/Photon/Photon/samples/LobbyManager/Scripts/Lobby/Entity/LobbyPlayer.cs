...
namespace Bolt.Samples.Photon.Lobby
{
    public class LobbyPlayer : Bolt.EntityEventListener<ILobbyPlayerInfoState>
    {
        ...
        static Color JoinColor = new Color(1.0f, 1.0f, 1.0f, 0f);
        static Color NotReadyColor = new Color(1.0f, 1.0f, 1.0f, 0f);
        ...
        public void SetupPlayer()
        {
            ...
            if (PlayerPrefs.GetString("PlayerName") == "")
                nameInput.text = string.Format("{0} #{1}", GenerateFullName(), Random.Range(1, 100));
            else 
                nameInput.text = PlayerPrefs.GetString("PlayerName");
            
            if (entity.IsOwner)
                state.Name = nameInput.text;
