...
namespace Bolt.Samples.Photon.Lobby
{
    public partial class LobbyManager
    {
        ...
        private void StartUI()
        {
            ...
            uiMainMenu.OnSpecialServerClick += StartSpecialClientEvent;
        ...
        {
            uiInfoPanel.Display("Not found. Returning to menu...");
        }
        ...
        private void StartSpecialClientEvent()
        {
            uiInfoPanel.Display("Connecting to Cloud...");
            StartSpecialClientEventHandler(uiMainMenu.SpecialMatchName, true);
        }

        private void StartClientRandomEvent()
        {
            uiInfoPanel.Display("Searching...", "Cancel_Settings");
